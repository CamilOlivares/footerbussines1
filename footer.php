    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 about-footer">
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-map-marker-alt"></i> 1 / 105 Bay Lights,<br/>Lorem Ipsum,<br/>LIC 3201</li>
                    </ul>
                ...
                <div class="col-md-6 col-lg-4 open-hours">
                    ...
                    <table class="table">
                        <tbody>
                            <tr><td><i class="far fa-clock"></i> Monday - Thursday</td><td>9:00am - 5:00pm</td></tr>
                            <tr><td><i class="far fa-clock"></i> Friday</td><td>9:00am - 4:00pm</td></tr>
                            <tr><td><i class="far fa-clock"></i> Saturday</td><td>9:00am - 1:30pm</td></tr>
                            <tr><td><i class="far fa-clock"></i> Sunday</td><td>9:30am - 12:00pm</td></tr>
                        </tbody>
                    </table>
                    <hr>
        ...
        <div class="footer-bottom">
            <div class="row">
                ...
                <div class="col-sm-8">
                    <p>Lorem ipsum dolor sit amet @ 2024 All rights reserved</p>
                </div>
            </div>
        </div>
    </div>
